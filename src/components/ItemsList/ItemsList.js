                  ...
                  <div className="card-body">
                    ...
                    <form onSubmit={event => this.handleSubmit(event)}>
                      <div className="form-group">
                        ...
                        >
                          <option ref={this.quantity} value="default">
                            Choisissez une quantité
                          </option>
                          <option ref={this.quantity} value="1">
                            1
                          </option>
                          <option ref={this.quantity} value="2">
                            2
                          </option>
                          <option ref={this.quantity} value="3">
                            3
                          </option>
                          <option ref={this.quantity} value="4">
                            4
                          </option>
                          <option ref={this.quantity} value="5">
                            5
                          </option>
                        </select>
                      </div>
